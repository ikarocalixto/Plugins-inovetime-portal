...
function revenda_importados() {
    global $revenda_importados_loaded;
    $revenda_importados_loaded = true; // Marca que o shortcode está sendo usado.
            ...
            <div class="content-area">
                ...
                <div class="slideshow-container">
                    <div class="mySlides fade" id="meuslideunico">
                        <img id="banner-img" src="https://i0.wp.com/inovetime.com.br/wp-content/uploads/Fashion-banner-loja-atacado.png?w=1200&ssl=1" style="width:100%">
                    </div>
...
// Adiciona o shortcode [revenda_importados] que pode ser usado em posts e páginas
add_shortcode('revenda_importados', 'revenda_importados');
