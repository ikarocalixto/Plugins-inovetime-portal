...
function revenda_hidratante() {
    global $revenda_hidratante_loaded;
    $revenda_hidratante_loaded = true; // Marca que o shortcode está sendo usado.
            ...
            <div class="content-area">
                ...
                <div class="slideshow-container">
                    <div class="mySlides fade" id="meuslideunico">
                        <img id="banner-img" src="https://inovetime.com.br/wp-content/uploads/Fashion-banner-loja-atacado-9.png" style="width:100%">
                    </div>
...
// Adiciona o shortcode [revenda_hidratante] que pode ser usado em posts e páginas
add_shortcode('revenda_hidratante', 'revenda_hidratante');
