...
function revenda_arabes() {
    global $revenda_arabes_loaded;
    $revenda_arabes_loaded = true; // Marca que o shortcode está sendo usado.
            ...
            <div class="content-area">
                ...
                <div class="slideshow-container">
                    <div class="mySlides fade" id="meuslideunico">
                        <img id="banner-img" src="https://inovetime.com.br/wp-content/uploads/Fashion-banner-loja-atacado-5.png" style="width:100%">
                    </div>
...
// Adiciona o shortcode [revenda_arabes] que pode ser usado em posts e páginas
add_shortcode('revenda_arabes', 'revenda_arabes');
