...
function meu_carrinho() {
    global $meu_carrinho_loaded;
    $meu_carrinho_loaded = true; // Marca que o shortcode está sendo usado.
...
// Adiciona o shortcode [meu_carrinho] que pode ser usado em posts e páginas
add_shortcode('meu_carrinho', 'meu_carrinho');
