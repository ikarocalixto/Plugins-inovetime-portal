...
function revenda_semi_seletivos() {
    global $revenda_semi_seletivos_loaded;
    $revenda_semi_seletivos_loaded = true; // Marca que o shortcode está sendo usado.
            ...
            <div class="content-area">
                ...
                <div class="slideshow-container">
                    <div class="mySlides fade" id="meuslideunico">
                        <img id="banner-img" src="https://inovetime.com.br/wp-content/uploads/Fashion-banner-loja-atacado-7.png" style="width:100%">
                    </div>
...
// Adiciona o shortcode [revenda_semi_seletivos] que pode ser usado em posts e páginas
add_shortcode('revenda_semi_seletivos', 'revenda_semi_seletivos');
