...
function portal_interno_adm_shortcode() {
...
?>
 ...
 <!-- final das informações do usuarios  -->
  ...
  <div class="mySlides fade" id="meuslideunico">
    <img src="https://inovetime.com.br/wp-content/uploads/Para-tela-do-computador-3.png" style="width:100%">
  </div>
  ...
  <a class="next" onclick="plusSlides(1)">&#10095;</a>
    ...
    <div class="card-section">
      ...
      <div class="cartao">[Colaborador_adm]</div>
...
// Adiciona o shortcode [portal_interno_adm] que pode ser usado em posts e páginas
add_shortcode('portal_interno_adm', 'portal_interno_adm_shortcode');
