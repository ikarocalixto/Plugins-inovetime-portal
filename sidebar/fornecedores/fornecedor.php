...
function fornecedor() {
    global $fornecedor_loaded;
    $fornecedor_loaded = true; // Marca que o shortcode está sendo usado.
        ...
        <?php if (is_user_logged_in()): // Verifica se o usuário está logado ?>
            ...
            <div class="content-area">
                ...
                <div class="slideshow-container">
                    ...
                    <div class="comissao">
                        <div>[mp_add_new_product_form]</div>
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
// Adiciona o shortcode [fornecedor] que pode ser usado em posts e páginas
add_shortcode('fornecedor', 'fornecedor');
