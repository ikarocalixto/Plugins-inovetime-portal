...
function info_loja() {
    global $info_loja_loaded;
    $info_loja_loaded = true; // Marca que o shortcode está sendo usado.
    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <!-- Início do menu -->
            <?php include(plugin_dir_path(__FILE__) . '../menu/menu.php'); ?>
            <!-- Fim do menu -->
...
// Adiciona o shortcode [info_loja] que pode ser usado em posts e páginas
add_shortcode('info_loja', 'info_loja');
