...
function meus_produtos() {
    global $meus_produtos_loaded;
    $meus_produtos_loaded = true; // Marca que o shortcode está sendo usado.
...
// Adiciona o shortcode [meus_produtos] que pode ser usado em posts e páginas
add_shortcode('meus_produtos', 'meus_produtos');
