...
function ver_chamados() {

    global $ver_chamados_loaded;
    $ver_chamados_loaded = true; // Marca que o shortcode está sendo usado.
...
// Adiciona o shortcode [ver_chamados] que pode ser usado em posts e páginas
add_shortcode('ver_chamados', 'ver_chamados');
