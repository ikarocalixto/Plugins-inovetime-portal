...
function abrir_chamado() {
    ...
    global $abrir_chamado_loaded;
    $abrir_chamado_loaded = true; // Marca que o shortcode está sendo usado.
...
?>
 ...
 <!-- final das informações do usuarios  -->
  ...
  <div class="content-area">
    ...
    <div class="frase"> <?php echo esc_html($nome); ?>, precisando de ajuda?</div>
<div></div>
...
// Adiciona o shortcode [abrir_chamado] que pode ser usado em posts e páginas
add_shortcode('abrir_chamado', 'abrir_chamado');
