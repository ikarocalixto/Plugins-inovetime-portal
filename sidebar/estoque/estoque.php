...
function estoque() {
    ...
    global $estoque_loaded;
    $estoque_loaded = true; // Marca que o shortcode está sendo usado.
...
// Adiciona o shortcode [estoque] que pode ser usado em posts e páginas
add_shortcode('estoque', 'estoque');
